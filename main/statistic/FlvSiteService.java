...
public class FlvSiteService {
	...
	public  void FlvStatic(int taskID,int taskInstanceId ,Short DBID){
		//视频网站统计
	...
	public  void statistic(int taskid,int instanceId,Short dbid){
		...
		try{
			String nodes = " SELECT NodeIP,NodeAreaId,NodeISPId FROM woaflvurl WHERE InstanceId='"+instanceId+"' GROUP BY NodeIP ";
